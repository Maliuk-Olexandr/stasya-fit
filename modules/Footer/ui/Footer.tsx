...
import { Link } from "@/modules/shared/i18n/navigation";
    ...
    <footer className={clsx("section", css.footer)}>
      <div className="container">
        <div className={css.footerContent}>
            ...
            <address>
              <ul className={css.infoList}>
                ...
                <li>
                  ...
                  <Link href="mailto:contact@stasyafit.com">
                    contact@stasyafit.com
                  </Link>
                </li>
              </ul>
            </address>
          ...
          <div className={css.contactDetails}>
            <h2 className={css.title}>
              {t("title.0")}{" "}
              <span className={css.titleSpan}>{t("title.1")}</span>
            </h2>
        ...
        <div className={css.footerBottom}>
          ...
          <p className={css.madeBy}>{t("Made")}</p>
        </div>
      </div>
    </footer>
  );
